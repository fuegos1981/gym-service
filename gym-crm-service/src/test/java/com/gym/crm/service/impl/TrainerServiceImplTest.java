...
class TrainerServiceImplTest {
    ...
    void checkIfCreatedTrainerIsCorrect() {
        ...
        TrainerProfile trainerProfile = new TrainerProfile()
                .firstName("Oleg")
                .lastName("Burov")
                .specialization(com.gym.crm.dto.TrainingType.BOX);
    ...
    void checkIfUpdatedTrainerIsCorrect() {
        ...
        UpdateTrainerRequest request = new UpdateTrainerRequest()
                ...
                .username("Maria.Torska")
                .specialization(com.gym.crm.dto.TrainingType.AEROBIC);

        when(repository.findByUserUsername(any())).thenReturn(ofNullable(trainer));
        when(trainingTypeRepository.findByName(eq(com.gym.crm.dto.TrainingType.AEROBIC.name())))
